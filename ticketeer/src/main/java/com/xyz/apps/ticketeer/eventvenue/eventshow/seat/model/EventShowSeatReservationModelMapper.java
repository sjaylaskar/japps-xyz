 ...
 */
@Component
public class EventShowSeatReservationModelMapper extends GeneralModelMapper<EventShowSeat, EventShowSeatModificationResponseDto> {

    /**
     * Instantiates a new event show seat model mapper.
     */
    public EventShowSeatReservationModelMapper() {
