...
@Table(
    uniqueConstraints =
       {@UniqueConstraint(name = "UNIQUE_eventshow_row_seat", columnNames = {"eventShowId", "rowName", "seatNumber"}),
        @UniqueConstraint(name = "UNIQUE_eventshow_seatnumber", columnNames = {"eventShowId", "seatNumber"})}
)
