...
public class CountryService extends GeneralService {
    ...
    public CountryDto add(@NotNull(message = Messages.MESSAGE_ERROR_NOT_NULL_COUNTRY) final CountryCreationDto countryCreationDto) {
     ...
     */
    @Transactional(rollbackFor = {Throwable.class})
    public CountryDtoList addAll(@NotNull(message = Messages.MESSAGE_ERROR_NOT_NULL_COUNTRY_LIST) final CountryCreationDtoList countryCreationDtoList) {
     ...
     */
    @Transactional(rollbackFor = {Throwable.class})
    public CountryDto update(@NotNull(message = Messages.MESSAGE_ERROR_NOT_NULL_COUNTRY) final CountryDto countryDto) {
     ...
     */
    @Transactional(rollbackFor = {Throwable.class})
    public void deleteById(@NotNull(message = Messages.MESSAGE_ERROR_NOT_NULL_COUNTRY_ID) final Long id) {
     ...
     */
    @Transactional(rollbackFor = {Throwable.class})
    public void deleteByCode(@NotNull(message = Messages.MESSAGE_ERROR_NOT_BLANK_COUNTRY_CODE) final String code) {
     ...
     * @return the country
     */
    public CountryDto findById(@NotNull(message = Messages.MESSAGE_ERROR_NOT_NULL_COUNTRY_ID) final Long id) {
     ...
     * @return the country
     */
    public CountryDto findByCode(@NotNull(message = Messages.MESSAGE_ERROR_NOT_BLANK_COUNTRY_CODE) final String code) {
